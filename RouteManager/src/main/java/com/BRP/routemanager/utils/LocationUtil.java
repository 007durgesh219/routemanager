...
public class LocationUtil implements GoogleApiClient.ConnectionCallbacks,
    ...
    public static boolean checkLocationPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            int permissionCheck = ContextCompat.checkSelfPermission(rmApp.getAppContext(),
    ...
    public static boolean isGPSOn() {
        LocationManager locationManager = (LocationManager) rmApp.getAppContext()
                .getSystemService(rmApp.getAppContext().LOCATION_SERVICE);
